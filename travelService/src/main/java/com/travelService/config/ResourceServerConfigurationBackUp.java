...
public class ResourceServerConfigurationBackUp /*extends ResourceServerConfigurerAdapter*/ {
	...
	public void configure(HttpSecurity http) throws Exception {
		*//*
		...
		http.antMatcher("/**")
        .authorizeRequests()
        .antMatchers("/v1/guest/**").permitAll().antMatchers("/v1/fileUpload/**").permitAll()
